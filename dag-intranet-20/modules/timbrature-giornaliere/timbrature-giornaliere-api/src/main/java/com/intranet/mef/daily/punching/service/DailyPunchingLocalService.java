...
/**
 * Provides the local service interface for DailyPunching. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DailyPunchingLocalServiceUtil
...
public interface DailyPunchingLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DailyPunchingLocalServiceUtil} to access the daily punching local service. Add custom service methods to {@link com.intranet.mef.daily.punching.service.impl.DailyPunchingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public DailyPunching createDailyPunching(java.lang.String custom_key);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public DailyPunching deleteDailyPunching(java.lang.String custom_key)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DailyPunching fetchDailyPunching(java.lang.String custom_key);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DailyPunching getDailyPunching(java.lang.String custom_key)
		throws PortalException;
