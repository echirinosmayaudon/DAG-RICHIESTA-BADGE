...
/**
 * The persistence interface for the orario service.
 *
 * <p>
 ...
 */
@ProviderType
public interface OrarioPersistence extends BasePersistence<Orario> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OrarioUtil} to access the orario persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(java.util.List<Orario> orarios);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, Orario> fetchByPrimaryKeys(
	...
	* @return the orarios
	*/
	public java.util.List<Orario> findAll();
	...
	*/
	public java.util.List<Orario> findAll(int start, int end);
	...
	*/
	public java.util.List<Orario> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Orario> orderByComparator);
