...
/**
 * Provides the local service utility for StatoAula. This utility wraps
 * {@link servizio.prenotazione.aule.mef.service.impl.StatoAulaLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class StatoAulaLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link servizio.prenotazione.aule.mef.service.impl.StatoAulaLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static int getStatoAulasCount() {
		return getService().getStatoAulasCount();
	}
	...
	*/
	public static java.util.List<servizio.prenotazione.aule.mef.model.StatoAula> getStatoAulas(
		int start, int end) {
		return getService().getStatoAulas(start, end);
	}
	...
	*/
	public static servizio.prenotazione.aule.mef.model.StatoAula addStatoAula(
		servizio.prenotazione.aule.mef.model.StatoAula statoAula) {
		return getService().addStatoAula(statoAula);
	}
	...
	*/
	public static servizio.prenotazione.aule.mef.model.StatoAula createStatoAula(
		long id_stato_aula) {
		return getService().createStatoAula(id_stato_aula);
	}
	...
	*/
	public static servizio.prenotazione.aule.mef.model.StatoAula deleteStatoAula(
		long id_stato_aula)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteStatoAula(id_stato_aula);
	}
	...
	*/
	public static servizio.prenotazione.aule.mef.model.StatoAula deleteStatoAula(
		servizio.prenotazione.aule.mef.model.StatoAula statoAula) {
		return getService().deleteStatoAula(statoAula);
	}

	public static servizio.prenotazione.aule.mef.model.StatoAula fetchStatoAula(
		long id_stato_aula) {
		return getService().fetchStatoAula(id_stato_aula);
	}
	...
	* @throws PortalException if a stato aula with the primary key could not be found
	*/
	public static servizio.prenotazione.aule.mef.model.StatoAula getStatoAula(
		long id_stato_aula)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getStatoAula(id_stato_aula);
	}
	...
	*/
	public static servizio.prenotazione.aule.mef.model.StatoAula updateStatoAula(
		servizio.prenotazione.aule.mef.model.StatoAula statoAula) {
		return getService().updateStatoAula(statoAula);
	}

	public static StatoAulaLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<StatoAulaLocalService, StatoAulaLocalService> _serviceTracker =
		ServiceTrackerFactory.open(StatoAulaLocalService.class);
}