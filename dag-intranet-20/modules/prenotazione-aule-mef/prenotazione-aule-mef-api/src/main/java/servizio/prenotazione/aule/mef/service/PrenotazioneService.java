...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=mefaule", "json.web.service.context.path=Prenotazione"}, service = PrenotazioneService.class)
@ProviderType
...
public interface PrenotazioneService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PrenotazioneServiceUtil} to access the prenotazione remote service. Add custom service methods to {@link servizio.prenotazione.aule.mef.service.impl.PrenotazioneServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
