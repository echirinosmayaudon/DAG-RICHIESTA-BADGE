...
/**
 * Provides the local service interface for ServizioLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ServizioLogLocalServiceUtil
...
public interface ServizioLogLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ServizioLogLocalServiceUtil} to access the servizio log local service. Add custom service methods to {@link servizio.prenotazione.aule.mef.service.impl.ServizioLogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ServizioLog> getServizioLogListByDescServizio(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ServizioLog> getServizioLogs(int start, int end);
	...
	*/
	...
	public ServizioLog addServizioLog(ServizioLog servizioLog);
	...
	*/
	public ServizioLog createServizioLog(long id_servizio);
	...
	*/
	...
	public ServizioLog deleteServizioLog(long id_servizio)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ServizioLog deleteServizioLog(ServizioLog servizioLog);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ServizioLog fetchServizioLog(long id_servizio);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ServizioLog getServizioLog(long id_servizio)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ServizioLog updateServizioLog(ServizioLog servizioLog);
}