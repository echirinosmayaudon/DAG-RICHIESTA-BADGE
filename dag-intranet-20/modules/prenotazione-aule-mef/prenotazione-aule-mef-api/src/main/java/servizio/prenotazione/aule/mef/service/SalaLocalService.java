...
/**
 * Provides the local service interface for Sala. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SalaLocalServiceUtil
...
public interface SalaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SalaLocalServiceUtil} to access the sala local service. Add custom service methods to {@link servizio.prenotazione.aule.mef.service.impl.SalaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Sala> getSalas(int start, int end);
	...
	* @return the new sala
	*/
	public Sala createSala(long id_sala);
	...
	*/
	...
	public Sala deleteSala(long id_sala) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Sala fetchSala(long id_sala);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Sala getSala(long id_sala) throws PortalException;
