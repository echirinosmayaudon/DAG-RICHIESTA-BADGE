...
/**
 * Provides the local service interface for Segreteria. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SegreteriaLocalServiceUtil
...
public interface SegreteriaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SegreteriaLocalServiceUtil} to access the segreteria local service. Add custom service methods to {@link com.intranet.mef.gestione.riunioni.service.impl.SegreteriaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Segreteria addSegreteria(Segreteria segreteria);
	...
	*/
	public Segreteria createSegreteria(long id_segreteria);
	...
	*/
	...
	public Segreteria deleteSegreteria(Segreteria segreteria);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Segreteria deleteSegreteria(long id_segreteria)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Segreteria fetchSegreteria(long id_segreteria);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Segreteria getSegreteria(long id_segreteria)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public Segreteria updateSegreteria(Segreteria segreteria);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Segreteria> getSegreterias(int start, int end);
