...
/**
 * Provides the local service interface for AmministrazioneConvocante. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AmministrazioneConvocanteLocalServiceUtil
...
public interface AmministrazioneConvocanteLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AmministrazioneConvocanteLocalServiceUtil} to access the amministrazione convocante local service. Add custom service methods to {@link com.intranet.mef.gestione.riunioni.service.impl.AmministrazioneConvocanteLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public AmministrazioneConvocante addAmministrazioneConvocante(
	...
	*/
	public AmministrazioneConvocante createAmministrazioneConvocante(
	...
	*/
	...
	public AmministrazioneConvocante deleteAmministrazioneConvocante(
		AmministrazioneConvocante amministrazioneConvocante);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public AmministrazioneConvocante deleteAmministrazioneConvocante(
		long id_amministrazione_convocante) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AmministrazioneConvocante fetchAmministrazioneConvocante(
		long id_amministrazione_convocante);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AmministrazioneConvocante getAmministrazioneConvocante(
		long id_amministrazione_convocante) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public AmministrazioneConvocante updateAmministrazioneConvocante(
		AmministrazioneConvocante amministrazioneConvocante);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AmministrazioneConvocante> getAmministrazioneConvocantes(
		int start, int end);
