...
/**
 * Provides the local service interface for Luogo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LuogoLocalServiceUtil
...
public interface LuogoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LuogoLocalServiceUtil} to access the luogo local service. Add custom service methods to {@link com.intranet.mef.gestione.riunioni.service.impl.LuogoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public Luogo createLuogo(long id_luogo);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Luogo deleteLuogo(long id_luogo) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Luogo fetchLuogo(long id_luogo);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Luogo getLuogo(long id_luogo) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Luogo> getLuogos(int start, int end);
