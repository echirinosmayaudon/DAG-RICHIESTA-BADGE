...
/**
 * Provides the local service interface for TipoRiunione. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TipoRiunioneLocalServiceUtil
...
public interface TipoRiunioneLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TipoRiunioneLocalServiceUtil} to access the tipo riunione local service. Add custom service methods to {@link com.intranet.mef.gestione.riunioni.service.impl.TipoRiunioneLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public TipoRiunione addTipoRiunione(TipoRiunione tipoRiunione);
	...
	*/
	public TipoRiunione createTipoRiunione(long id_tipo);
	...
	*/
	...
	public TipoRiunione deleteTipoRiunione(TipoRiunione tipoRiunione);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public TipoRiunione deleteTipoRiunione(long id_tipo)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TipoRiunione fetchTipoRiunione(long id_tipo);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TipoRiunione getTipoRiunione(long id_tipo) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public TipoRiunione updateTipoRiunione(TipoRiunione tipoRiunione);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TipoRiunione> getTipoRiuniones(int start, int end);
