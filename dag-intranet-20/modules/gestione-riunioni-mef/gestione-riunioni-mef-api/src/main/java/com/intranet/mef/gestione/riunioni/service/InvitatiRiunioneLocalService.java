...
/**
 * Provides the local service interface for InvitatiRiunione. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see InvitatiRiunioneLocalServiceUtil
...
public interface InvitatiRiunioneLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link InvitatiRiunioneLocalServiceUtil} to access the invitati riunione local service. Add custom service methods to {@link com.intranet.mef.gestione.riunioni.service.impl.InvitatiRiunioneLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<InvitatiRiunione> getInvitatiRiunioneBySegreteria(
		long id_segreteria);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<InvitatiRiunione> getInvitatiRiunioneBySegreteriaRiunione(
