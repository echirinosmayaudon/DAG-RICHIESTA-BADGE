...
/**
 * Provides the local service interface for StatoInvitato. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see StatoInvitatoLocalServiceUtil
...
public interface StatoInvitatoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StatoInvitatoLocalServiceUtil} to access the stato invitato local service. Add custom service methods to {@link com.intranet.mef.gestione.riunioni.service.impl.StatoInvitatoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
