...
/**
 * Provides the local service interface for StatoRiunione. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see StatoRiunioneLocalServiceUtil
...
public interface StatoRiunioneLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StatoRiunioneLocalServiceUtil} to access the stato riunione local service. Add custom service methods to {@link com.intranet.mef.gestione.riunioni.service.impl.StatoRiunioneLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public StatoRiunione addStatoRiunione(StatoRiunione statoRiunione);
	...
	*/
	public StatoRiunione createStatoRiunione(long id_stato_riunione);
	...
	*/
	...
	public StatoRiunione deleteStatoRiunione(StatoRiunione statoRiunione);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public StatoRiunione deleteStatoRiunione(long id_stato_riunione)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public StatoRiunione fetchStatoRiunione(long id_stato_riunione);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public StatoRiunione getStatoRiunione(long id_stato_riunione)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public StatoRiunione updateStatoRiunione(StatoRiunione statoRiunione);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public int getStatoRiunionesCount();
	...
	*/
	...
	public List<StatoRiunione> findByLabel(java.lang.String label);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<StatoRiunione> getStatoRiuniones(int start, int end);
