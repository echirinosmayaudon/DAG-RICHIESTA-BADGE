package it.accenture.forecast.portlet;
...
import it.accenture.forecast.configuration.WeatherPortletInstanceConfiguration;
import it.accenture.forecast.model.DarkSky;
import it.accenture.forecast.service.api.WeatherService;

@Component(
	configurationPid =
				"it.accenture.forecast.configuration.WeatherPortletInstanceConfiguration",
	immediate = true,
	property = {
