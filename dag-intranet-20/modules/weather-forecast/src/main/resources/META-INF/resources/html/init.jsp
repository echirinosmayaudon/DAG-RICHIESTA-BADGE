...
<%@ page import="it.accenture.forecast.configuration.WeatherPortletInstanceConfiguration" %>
<%@ page import="it.accenture.forecast.model.DarkSky" %>
...
<%
    ...
    String coloricon = StringPool.BLANK;
    ...
    if (Validator.isNotNull(weatherPortletInstanceConfiguration)) {
        ...
        coloricon = weatherPortletInstanceConfiguration.coloricon();
