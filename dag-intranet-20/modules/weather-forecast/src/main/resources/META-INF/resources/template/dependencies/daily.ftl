...
<hr />
<#assign toDay = conversionsUtil.getDayWeekDisplayName(currently.getTime(), locale, timeZone.getID())>
${toDay} ${datum.getTime()}
<#list daily.getData() as datum>
	
	<#if toDay != conversionsUtil.getDayWeekDisplayName(datum.getTime(), locale, timeZone.getID()) || datum.getTime gt currently.getTime()>
		<div class="row">
		    <div class="col-md-4 col-xs-3 dayWeek">
		       ivan ${conversionsUtil.getDayWeekDisplayName(datum.getTime(), locale, timeZone.getID())} ${datum.getTime()}
		    </div>
