...
<%--                             <button type="button" class="btn-default" onclick="<portlet:namespace />getMyLocation();"><liferay-ui:message key="use-my-location" /></button> --%>
                            <em id="<portlet:namespace />status" aria-hidden="true"></em>
                    </div>
            ...
            <aui:fieldset-group markupView="lexicon">
                <aui:fieldset collapsible="<%= true %>" label="options">
                    ...
                    <aui:select name="preferences--windUnits--">
                        ...
                        <aui:option selected='<%= windUnits.equals("meters") %>' value="meters"><liferay-ui:message key="meters" /></aui:option>
                    </aui:select>
                      <aui:input name="preferences--coloricon--" type="text" value="<%= coloricon%>" helpMessage="requestColorIcon-help"/>
                </aui:fieldset>
            </aui:fieldset-group>
...
<%--             </aui:fieldset-group> --%>
            ...
            <div class="row">
                <div class="col-md-12">
                    <a href="https://darksky.net" target="_blank"><img src="https://darksky.net/dev/img/attribution/poweredby.png" height="30px" border="0" alt="DarkSky"/></a>
                </div>
            </div>
        </div>
    </div>
