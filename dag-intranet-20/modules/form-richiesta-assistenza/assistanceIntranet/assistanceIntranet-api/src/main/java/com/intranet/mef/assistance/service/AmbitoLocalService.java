...
/**
 * Provides the local service interface for Ambito. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AmbitoLocalServiceUtil
...
public interface AmbitoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AmbitoLocalServiceUtil} to access the ambito local service. Add custom service methods to {@link com.intranet.mef.assistance.service.impl.AmbitoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public Ambito createAmbito(java.lang.String assScopeId);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Ambito deleteAmbito(java.lang.String assScopeId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Ambito fetchAmbito(java.lang.String assScopeId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Ambito getAmbito(java.lang.String assScopeId)
		throws PortalException;
