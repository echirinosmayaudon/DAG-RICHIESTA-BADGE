...
public interface AreaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AreaLocalServiceUtil} to access the area local service. Add custom service methods to {@link com.intranet.mef.assistance.service.impl.AreaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	* @return the new area
	*/
	public Area createArea(java.lang.String areaId);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Area deleteArea(java.lang.String areaId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Area fetchArea(java.lang.String areaId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Area getArea(java.lang.String areaId) throws PortalException;
	...
	*/
	...
	public List<Area> findByServiceId(java.lang.String assServiceId);
