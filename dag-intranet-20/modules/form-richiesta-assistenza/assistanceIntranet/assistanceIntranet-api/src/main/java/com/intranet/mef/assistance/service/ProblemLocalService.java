...
/**
 * Provides the local service interface for Problem. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProblemLocalServiceUtil
...
public interface ProblemLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProblemLocalServiceUtil} to access the problem local service. Add custom service methods to {@link com.intranet.mef.assistance.service.impl.ProblemLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public Problem createProblem(java.lang.String problemId);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Problem deleteProblem(java.lang.String problemId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Problem fetchProblem(java.lang.String problemId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Problem getProblem(java.lang.String problemId)
		throws PortalException;
	...
	*/
	...
	public List<Problem> findByTopicId(java.lang.String topicId);
