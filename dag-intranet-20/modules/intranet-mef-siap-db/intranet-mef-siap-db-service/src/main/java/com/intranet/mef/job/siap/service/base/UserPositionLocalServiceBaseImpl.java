...
import com.intranet.mef.job.siap.service.UserPositionLocalService;
...
/**
 * Provides the base implementation for the user position local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.intranet.mef.job.siap.service.impl.UserPositionLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class UserPositionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UserPositionLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.intranet.mef.job.siap.service.UserPositionLocalServiceUtil} to access the user position local service.
	 */
	...
	public UserPosition addUserPosition(UserPosition userPosition) {
		...
		return userPositionPersistence.update(userPosition);
	}
	 ...
	 */
	@Override
	public UserPosition createUserPosition(String pos) {
		return userPositionPersistence.create(pos);
	}
	...
	@Override
	public UserPosition deleteUserPosition(String pos)
		throws PortalException {
		return userPositionPersistence.remove(pos);
	}
	...
	public UserPosition deleteUserPosition(UserPosition userPosition) {
		return userPositionPersistence.remove(userPosition);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UserPosition.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return userPositionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return userPositionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UserPosition fetchUserPosition(String pos) {
		return userPositionPersistence.fetchByPrimaryKey(pos);
	}
	 ...
	 */
	@Override
	public UserPosition getUserPosition(String pos) throws PortalException {
		return userPositionPersistence.findByPrimaryKey(pos);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return userPositionLocalService.deleteUserPosition((UserPosition)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return userPositionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<UserPosition> getUserPositions(int start, int end) {
		return userPositionPersistence.findAll(start, end);
	}
	...
	public int getUserPositionsCount() {
		return userPositionPersistence.countAll();
	}
	 ...
	 */
	public UserPositionLocalService getUserPositionLocalService() {
	...
	public void setUserPositionLocalService(
		UserPositionLocalService userPositionLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.intranet.mef.job.siap.model.UserPosition",
			userPositionLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.intranet.mef.job.siap.model.UserPosition");
	}
	...
	public String getOSGiServiceIdentifier() {
		return UserPositionLocalService.class.getName();
	}
	...
	@BeanReference(type = UserPositionLocalService.class)
	protected UserPositionLocalService userPositionLocalService;
