...
import com.intranet.mef.job.siap.service.UserPositionService;
...
/**
 * Provides the base implementation for the user position remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.intranet.mef.job.siap.service.impl.UserPositionServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class UserPositionServiceBaseImpl extends BaseServiceImpl
	implements UserPositionService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.intranet.mef.job.siap.service.UserPositionServiceUtil} to access the user position remote service.
	 */
	 ...
	 */
	public UserPositionService getUserPositionService() {
	...
	public String getOSGiServiceIdentifier() {
		return UserPositionService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = userPositionPersistence.getDataSource();
	...
	@BeanReference(type = UserPositionService.class)
