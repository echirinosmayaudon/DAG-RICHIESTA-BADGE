...
import com.intranet.mef.job.siap.service.CurrentBalanceHoursService;
...
/**
 * Provides the base implementation for the current balance hours remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.intranet.mef.job.siap.service.impl.CurrentBalanceHoursServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CurrentBalanceHoursServiceBaseImpl extends BaseServiceImpl
	implements CurrentBalanceHoursService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.intranet.mef.job.siap.service.CurrentBalanceHoursServiceUtil} to access the current balance hours remote service.
	 */
	 ...
	 */
	public CurrentBalanceHoursService getCurrentBalanceHoursService() {
	...
	public String getOSGiServiceIdentifier() {
		return CurrentBalanceHoursService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = currentBalanceHoursPersistence.getDataSource();
	...
	@BeanReference(type = CurrentBalanceHoursService.class)
	protected CurrentBalanceHoursService currentBalanceHoursService;
