...
import com.intranet.mef.job.siap.service.MealTicketLocalService;
...
/**
 * Provides the base implementation for the meal ticket local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.intranet.mef.job.siap.service.impl.MealTicketLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class MealTicketLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MealTicketLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.intranet.mef.job.siap.service.MealTicketLocalServiceUtil} to access the meal ticket local service.
	 */
	...
	public MealTicket addMealTicket(MealTicket mealTicket) {
		...
		return mealTicketPersistence.update(mealTicket);
	}
	 ...
	 */
	@Override
	public MealTicket createMealTicket(String custom_key) {
		return mealTicketPersistence.create(custom_key);
	}
	...
	@Override
	public MealTicket deleteMealTicket(String custom_key)
		throws PortalException {
		return mealTicketPersistence.remove(custom_key);
	}
	...
	public MealTicket deleteMealTicket(MealTicket mealTicket) {
		return mealTicketPersistence.remove(mealTicket);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MealTicket.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return mealTicketPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return mealTicketPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return mealTicketPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MealTicket fetchMealTicket(String custom_key) {
		return mealTicketPersistence.fetchByPrimaryKey(custom_key);
	}
	 ...
	 */
	@Override
	public MealTicket getMealTicket(String custom_key)
		throws PortalException {
		return mealTicketPersistence.findByPrimaryKey(custom_key);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return mealTicketLocalService.deleteMealTicket((MealTicket)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return mealTicketPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<MealTicket> getMealTickets(int start, int end) {
		return mealTicketPersistence.findAll(start, end);
	}
	...
	public int getMealTicketsCount() {
		return mealTicketPersistence.countAll();
	}
	 ...
	 */
	public MealTicketLocalService getMealTicketLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.intranet.mef.job.siap.model.MealTicket",
			mealTicketLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.intranet.mef.job.siap.model.MealTicket");
	}
	...
	public String getOSGiServiceIdentifier() {
		return MealTicketLocalService.class.getName();
	}
	...
	@BeanReference(type = MealTicketLocalService.class)
	protected MealTicketLocalService mealTicketLocalService;
