...
import com.intranet.mef.job.siap.service.PunchingLocalService;
...
/**
 * Provides the base implementation for the punching local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.intranet.mef.job.siap.service.impl.PunchingLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class PunchingLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements PunchingLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.intranet.mef.job.siap.service.PunchingLocalServiceUtil} to access the punching local service.
	 */
	...
	public Punching addPunching(Punching punching) {
		...
		return punchingPersistence.update(punching);
	}
	 ...
	 */
	@Override
	public Punching createPunching(String custom_key) {
		return punchingPersistence.create(custom_key);
	}
	...
	@Override
	public Punching deletePunching(String custom_key) throws PortalException {
		return punchingPersistence.remove(custom_key);
	}
	...
	public Punching deletePunching(Punching punching) {
		return punchingPersistence.remove(punching);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Punching.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return punchingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return punchingPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return punchingPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return punchingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Punching fetchPunching(String custom_key) {
		return punchingPersistence.fetchByPrimaryKey(custom_key);
	}
	 ...
	 */
	@Override
	public Punching getPunching(String custom_key) throws PortalException {
		return punchingPersistence.findByPrimaryKey(custom_key);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return punchingLocalService.deletePunching((Punching)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return punchingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Punching> getPunchings(int start, int end) {
		return punchingPersistence.findAll(start, end);
	}
	...
	public int getPunchingsCount() {
		return punchingPersistence.countAll();
	}
	 ...
	 */
	public PunchingLocalService getPunchingLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.intranet.mef.job.siap.model.Punching",
			punchingLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.intranet.mef.job.siap.model.Punching");
	}
	...
	public String getOSGiServiceIdentifier() {
		return PunchingLocalService.class.getName();
	}
	...
	@BeanReference(type = PunchingLocalService.class)
	protected PunchingLocalService punchingLocalService;
