...
/**
 * Provides the local service interface for OvertimeBalance. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OvertimeBalanceLocalServiceUtil
...
public interface OvertimeBalanceLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OvertimeBalanceLocalServiceUtil} to access the overtime balance local service. Add custom service methods to {@link com.intranet.mef.job.siap.service.impl.OvertimeBalanceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public OvertimeBalance addOvertimeBalance(OvertimeBalance overtimeBalance);
	...
	*/
	public OvertimeBalance createOvertimeBalance(long personId);
	...
	*/
	...
	public OvertimeBalance deleteOvertimeBalance(
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public OvertimeBalance deleteOvertimeBalance(long personId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OvertimeBalance fetchOvertimeBalance(long personId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OvertimeBalance getOvertimeBalance(long personId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public OvertimeBalance updateOvertimeBalance(
		OvertimeBalance overtimeBalance);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OvertimeBalance> getOvertimeBalances(int start, int end);
