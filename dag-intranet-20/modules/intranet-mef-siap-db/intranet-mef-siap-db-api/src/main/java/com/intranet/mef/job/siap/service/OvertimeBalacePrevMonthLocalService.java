...
/**
 * Provides the local service interface for OvertimeBalacePrevMonth. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OvertimeBalacePrevMonthLocalServiceUtil
...
public interface OvertimeBalacePrevMonthLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OvertimeBalacePrevMonthLocalServiceUtil} to access the overtime balace prev month local service. Add custom service methods to {@link com.intranet.mef.job.siap.service.impl.OvertimeBalacePrevMonthLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public OvertimeBalacePrevMonth addOvertimeBalacePrevMonth(
	...
	*/
	public OvertimeBalacePrevMonth createOvertimeBalacePrevMonth(long personId);
	...
	*/
	...
	public OvertimeBalacePrevMonth deleteOvertimeBalacePrevMonth(
		OvertimeBalacePrevMonth overtimeBalacePrevMonth);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public OvertimeBalacePrevMonth deleteOvertimeBalacePrevMonth(long personId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OvertimeBalacePrevMonth fetchOvertimeBalacePrevMonth(long personId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OvertimeBalacePrevMonth getOvertimeBalacePrevMonth(long personId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public OvertimeBalacePrevMonth updateOvertimeBalacePrevMonth(
		OvertimeBalacePrevMonth overtimeBalacePrevMonth);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OvertimeBalacePrevMonth> getOvertimeBalacePrevMonths(
		int start, int end);
