...
/**
 * The persistence interface for the current balance hours service.
 *
 * <p>
 ...
 * @see CurrentBalanceHoursUtil
 * @generated
 */
@ProviderType
public interface CurrentBalanceHoursPersistence extends BasePersistence<CurrentBalanceHours> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CurrentBalanceHoursUtil} to access the current balance hours persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(
		java.util.List<CurrentBalanceHours> currentBalanceHourses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, CurrentBalanceHours> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<CurrentBalanceHours> findAll();
	...
	*/
	public java.util.List<CurrentBalanceHours> findAll(int start, int end);
	...
	*/
	public java.util.List<CurrentBalanceHours> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<CurrentBalanceHours> orderByComparator);
