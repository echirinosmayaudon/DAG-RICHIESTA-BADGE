...
/**
 * Provides the local service interface for OrganizationChart. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OrganizationChartLocalServiceUtil
...
public interface OrganizationChartLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OrganizationChartLocalServiceUtil} to access the organization chart local service. Add custom service methods to {@link com.intranet.mef.job.siap.service.impl.OrganizationChartLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public OrganizationChart addOrganizationChart(
	...
	*/
	public OrganizationChart createOrganizationChart(long idOrgChart);
	...
	*/
	...
	public OrganizationChart deleteOrganizationChart(
		OrganizationChart organizationChart);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public OrganizationChart deleteOrganizationChart(long idOrgChart)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OrganizationChart fetchOrganizationChart(long idOrgChart);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OrganizationChart getOrganizationChart(long idOrgChart)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public OrganizationChart updateOrganizationChart(
		OrganizationChart organizationChart);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OrganizationChart> getChildrenByLevelAndIdOrgChart(int level,
		long idOrgChart);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OrganizationChart> getOrganizationCharts(int start, int end);
