...
/**
 * Provides the local service interface for MealTicket. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MealTicketLocalServiceUtil
...
public interface MealTicketLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MealTicketLocalServiceUtil} to access the meal ticket local service. Add custom service methods to {@link com.intranet.mef.job.siap.service.impl.MealTicketLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public MealTicket addMealTicket(MealTicket mealTicket);
	...
	*/
	public MealTicket createMealTicket(java.lang.String custom_key);
	...
	*/
	...
	public MealTicket deleteMealTicket(MealTicket mealTicket);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public MealTicket deleteMealTicket(java.lang.String custom_key)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MealTicket fetchMealTicket(java.lang.String custom_key);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MealTicket getMealTicket(java.lang.String custom_key)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public MealTicket updateMealTicket(MealTicket mealTicket);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MealTicket> getMealTickets(int start, int end);
