...
/**
 * Provides the local service interface for UserPosition. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserPositionLocalServiceUtil
...
public interface UserPositionLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserPositionLocalServiceUtil} to access the user position local service. Add custom service methods to {@link com.intranet.mef.job.siap.service.impl.UserPositionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public UserPosition createUserPosition(java.lang.String pos);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public UserPosition deleteUserPosition(java.lang.String pos)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserPosition fetchUserPosition(java.lang.String pos);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserPosition getUserPosition(java.lang.String pos)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UserPosition> getUserPositions(int start, int end);
