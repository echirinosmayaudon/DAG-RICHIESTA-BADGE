...
/**
 * Provides the local service interface for ProfilePicture. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProfilePictureLocalServiceUtil
...
public interface ProfilePictureLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProfilePictureLocalServiceUtil} to access the profile picture local service. Add custom service methods to {@link com.intranet.mef.job.siap.service.impl.ProfilePictureLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public ProfilePicture createProfilePicture(long personID);
	...
	*/
	...
	public ProfilePicture deleteProfilePicture(ProfilePicture profilePicture);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ProfilePicture deleteProfilePicture(long personID)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProfilePicture fetchProfilePicture(long personID);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProfilePicture getProfilePicture(long personID)
		throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProfilePictureFileBlobModel getFileBlobModel(Serializable primaryKey);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ProfilePicture> getProfilePictures(int start, int end);
