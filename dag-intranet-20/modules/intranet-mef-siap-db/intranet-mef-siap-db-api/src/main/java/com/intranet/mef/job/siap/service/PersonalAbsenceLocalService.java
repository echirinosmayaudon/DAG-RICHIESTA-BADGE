...
/**
 * Provides the local service interface for PersonalAbsence. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PersonalAbsenceLocalServiceUtil
...
public interface PersonalAbsenceLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PersonalAbsenceLocalServiceUtil} to access the personal absence local service. Add custom service methods to {@link com.intranet.mef.job.siap.service.impl.PersonalAbsenceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public PersonalAbsence addPersonalAbsence(PersonalAbsence personalAbsence);
	...
	*/
	public PersonalAbsence createPersonalAbsence(java.lang.String custom_key);
	...
	*/
	...
	public PersonalAbsence deletePersonalAbsence(
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public PersonalAbsence deletePersonalAbsence(java.lang.String custom_key)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PersonalAbsence fetchPersonalAbsence(java.lang.String custom_key);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PersonalAbsence getPersonalAbsence(java.lang.String custom_key)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public PersonalAbsence updatePersonalAbsence(
		PersonalAbsence personalAbsence);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PersonalAbsence> getByPersonIdAndRefMonth(long personId,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PersonalAbsence> getPersonalAbsences(int start, int end);
