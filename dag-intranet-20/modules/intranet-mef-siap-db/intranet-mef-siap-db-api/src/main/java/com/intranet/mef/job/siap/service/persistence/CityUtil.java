...
public class CityUtil {
	...
	* @return the new city
	*/
	public static City create(java.lang.String istatCode) {
		return getPersistence().create(istatCode);
	}
	...
	*/
	public static City remove(java.lang.String istatCode)
		throws com.intranet.mef.job.siap.exception.NoSuchCityException {
		return getPersistence().remove(istatCode);
	}
	...
	* @throws NoSuchCityException if a city with the primary key could not be found
	*/
	public static City findByPrimaryKey(java.lang.String istatCode)
		throws com.intranet.mef.job.siap.exception.NoSuchCityException {
		return getPersistence().findByPrimaryKey(istatCode);
	}
	...
	*/
	public static City fetchByPrimaryKey(java.lang.String istatCode) {
		return getPersistence().fetchByPrimaryKey(istatCode);
	}
	...
	*/
	...
	private static ServiceTracker<CityPersistence, CityPersistence> _serviceTracker =
		ServiceTrackerFactory.open(CityPersistence.class);
}