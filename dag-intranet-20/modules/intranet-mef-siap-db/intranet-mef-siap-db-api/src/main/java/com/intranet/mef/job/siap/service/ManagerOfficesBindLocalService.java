...
/**
 * Provides the local service interface for ManagerOfficesBind. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ManagerOfficesBindLocalServiceUtil
...
public interface ManagerOfficesBindLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ManagerOfficesBindLocalServiceUtil} to access the manager offices bind local service. Add custom service methods to {@link com.intranet.mef.job.siap.service.impl.ManagerOfficesBindLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ManagerOfficesBind addManagerOfficesBind(
	...
	*/
	public ManagerOfficesBind createManagerOfficesBind(
	...
	*/
	...
	public ManagerOfficesBind deleteManagerOfficesBind(
		ManagerOfficesBind managerOfficesBind);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ManagerOfficesBind deleteManagerOfficesBind(
		ManagerOfficesBindPK managerOfficesBindPK) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ManagerOfficesBind fetchManagerOfficesBind(
		ManagerOfficesBindPK managerOfficesBindPK);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ManagerOfficesBind fetchManagerOfficesBindByP_I(long personId,
		long idOrgChart);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ManagerOfficesBind getManagerOfficesBind(
		ManagerOfficesBindPK managerOfficesBindPK) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ManagerOfficesBind updateManagerOfficesBind(
		ManagerOfficesBind managerOfficesBind);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ManagerOfficesBind> getManagerOfficesBindByPersonId(
		long personId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ManagerOfficesBind> getManagerOfficesBinds(int start, int end);
