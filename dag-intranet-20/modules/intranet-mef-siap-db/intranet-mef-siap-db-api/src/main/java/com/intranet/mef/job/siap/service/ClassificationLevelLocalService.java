...
/**
 * Provides the local service interface for ClassificationLevel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ClassificationLevelLocalServiceUtil
...
public interface ClassificationLevelLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ClassificationLevelLocalServiceUtil} to access the classification level local service. Add custom service methods to {@link com.intranet.mef.job.siap.service.impl.ClassificationLevelLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ClassificationLevel addClassificationLevel(
	...
	*/
	public ClassificationLevel createClassificationLevel(long levelID);
	...
	*/
	...
	public ClassificationLevel deleteClassificationLevel(
		ClassificationLevel classificationLevel);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ClassificationLevel deleteClassificationLevel(long levelID)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ClassificationLevel fetchClassificationLevel(long levelID);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ClassificationLevel getClassificationLevel(long levelID)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ClassificationLevel updateClassificationLevel(
		ClassificationLevel classificationLevel);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ClassificationLevel> getClassificationLevels(int start, int end);
