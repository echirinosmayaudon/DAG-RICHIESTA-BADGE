...
/**
 * Provides the local service interface for Punching. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PunchingLocalServiceUtil
...
public interface PunchingLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PunchingLocalServiceUtil} to access the punching local service. Add custom service methods to {@link com.intranet.mef.job.siap.service.impl.PunchingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Punching addPunching(Punching punching);
	...
	*/
	public Punching createPunching(java.lang.String custom_key);
	...
	*/
	...
	public Punching deletePunching(Punching punching);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Punching deletePunching(java.lang.String custom_key)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Punching fetchPunching(java.lang.String custom_key);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Punching getPunching(java.lang.String custom_key)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public Punching updatePunching(Punching punching);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Punching> getPunchings(int start, int end);
