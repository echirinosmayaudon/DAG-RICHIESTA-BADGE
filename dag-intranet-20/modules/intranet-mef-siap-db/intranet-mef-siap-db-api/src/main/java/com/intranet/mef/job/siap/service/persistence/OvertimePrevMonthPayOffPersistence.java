...
/**
 * The persistence interface for the overtime prev month pay off service.
 *
 * <p>
 ...
 * @see OvertimePrevMonthPayOffUtil
 * @generated
 */
@ProviderType
public interface OvertimePrevMonthPayOffPersistence extends BasePersistence<OvertimePrevMonthPayOff> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OvertimePrevMonthPayOffUtil} to access the overtime prev month pay off persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(
		java.util.List<OvertimePrevMonthPayOff> overtimePrevMonthPayOffs);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, OvertimePrevMonthPayOff> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<OvertimePrevMonthPayOff> findAll();
	...
	*/
	public java.util.List<OvertimePrevMonthPayOff> findAll(int start, int end);
	...
	*/
	public java.util.List<OvertimePrevMonthPayOff> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<OvertimePrevMonthPayOff> orderByComparator);
