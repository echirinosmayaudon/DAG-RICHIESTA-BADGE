...
/**
 * Provides the local service interface for Festivity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FestivityLocalServiceUtil
...
public interface FestivityLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FestivityLocalServiceUtil} to access the festivity local service. Add custom service methods to {@link com.intranet.mef.job.siap.service.impl.FestivityLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
