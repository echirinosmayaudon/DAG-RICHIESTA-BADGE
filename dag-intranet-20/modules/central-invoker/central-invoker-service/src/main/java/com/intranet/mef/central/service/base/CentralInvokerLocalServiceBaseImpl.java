...
package com.intranet.mef.central.service.base;

import aQute.bnd.annotation.ProviderType;

import com.intranet.mef.central.model.CentralInvoker;
import com.intranet.mef.central.service.CentralInvokerLocalService;
...
/**
 * Provides the base implementation for the central invoker local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.intranet.mef.central.service.impl.CentralInvokerLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class CentralInvokerLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CentralInvokerLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.intranet.mef.central.service.CentralInvokerLocalServiceUtil} to access the central invoker local service.
	 */
	...
	public CentralInvoker addCentralInvoker(CentralInvoker centralInvoker) {
		...
		return centralInvokerPersistence.update(centralInvoker);
	}
	...
	public CentralInvoker createCentralInvoker(long idRecord) {
		return centralInvokerPersistence.create(idRecord);
	}
	...
	public CentralInvoker deleteCentralInvoker(long idRecord)
		...
		return centralInvokerPersistence.remove(idRecord);
	}
	...
	public CentralInvoker deleteCentralInvoker(CentralInvoker centralInvoker) {
		return centralInvokerPersistence.remove(centralInvoker);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CentralInvoker.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return centralInvokerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return centralInvokerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public CentralInvoker fetchCentralInvoker(long idRecord) {
		return centralInvokerPersistence.fetchByPrimaryKey(idRecord);
	}
	...
	public CentralInvoker getCentralInvoker(long idRecord)
		throws PortalException {
		return centralInvokerPersistence.findByPrimaryKey(idRecord);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(centralInvokerLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CentralInvoker.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("idRecord");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(centralInvokerLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CentralInvoker.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("idRecord");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return centralInvokerLocalService.deleteCentralInvoker((CentralInvoker)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return centralInvokerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CentralInvoker> getCentralInvokers(int start, int end) {
		return centralInvokerPersistence.findAll(start, end);
	}
	...
	public int getCentralInvokersCount() {
		return centralInvokerPersistence.countAll();
	}
	...
	/**
	 * Returns the central invoker local service.
	 *
	 * @return the central invoker local service
	 */
	public CentralInvokerLocalService getCentralInvokerLocalService() {
		return centralInvokerLocalService;
	}

	/**
	 * Sets the central invoker local service.
	 *
	 * @param centralInvokerLocalService the central invoker local service
	 */
	public void setCentralInvokerLocalService(
		CentralInvokerLocalService centralInvokerLocalService) {
		this.centralInvokerLocalService = centralInvokerLocalService;
	}

	/**
	 * Returns the central invoker persistence.
	 *
	 * @return the central invoker persistence
	 */
	public CentralInvokerPersistence getCentralInvokerPersistence() {
		return centralInvokerPersistence;
	}

	/**
	 * Sets the central invoker persistence.
	 *
	 * @param centralInvokerPersistence the central invoker persistence
	 */
	public void setCentralInvokerPersistence(
		CentralInvokerPersistence centralInvokerPersistence) {
		this.centralInvokerPersistence = centralInvokerPersistence;
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.intranet.mef.central.model.CentralInvoker",
			centralInvokerLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.intranet.mef.central.model.CentralInvoker");
	}
	...
	public String getOSGiServiceIdentifier() {
		return CentralInvokerLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = centralInvokerPersistence.getDataSource();
	...
	@BeanReference(type = CentralInvokerLocalService.class)
	protected CentralInvokerLocalService centralInvokerLocalService;
	@BeanReference(type = CentralInvokerPersistence.class)
	protected CentralInvokerPersistence centralInvokerPersistence;
