...
/**
 * Provides the local service interface for AutorizzazioneDir. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AutorizzazioneDirLocalServiceUtil
...
public interface AutorizzazioneDirLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AutorizzazioneDirLocalServiceUtil} to access the autorizzazione dir local service. Add custom service methods to {@link autorizzazione.dir.mef.service.impl.AutorizzazioneDirLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
