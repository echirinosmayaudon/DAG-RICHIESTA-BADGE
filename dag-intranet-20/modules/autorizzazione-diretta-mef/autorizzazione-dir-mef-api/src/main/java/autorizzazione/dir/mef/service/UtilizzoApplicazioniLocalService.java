...
/**
 * Provides the local service interface for UtilizzoApplicazioni. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UtilizzoApplicazioniLocalServiceUtil
...
public interface UtilizzoApplicazioniLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UtilizzoApplicazioniLocalServiceUtil} to access the utilizzo applicazioni local service. Add custom service methods to {@link autorizzazione.dir.mef.service.impl.UtilizzoApplicazioniLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
