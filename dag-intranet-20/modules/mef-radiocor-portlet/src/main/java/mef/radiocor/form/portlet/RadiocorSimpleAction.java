...
public class RadiocorSimpleAction extends SimpleAction {
    ...
    private void doRun(long companyId) {
        PortalCache<String, Serializable> portalCache = MultiVMPoolUtil.getPortalCache(JsonRadiocor.class.getName());
    ...
    private static Log _log = LogFactoryUtil.getLog(RadiocorSimpleAction.class);
}
