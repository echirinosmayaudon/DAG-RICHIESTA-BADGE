...
/**
 * Provides the local service interface for StrumEvento. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see StrumEventoLocalServiceUtil
...
public interface StrumEventoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StrumEventoLocalServiceUtil} to access the strum evento local service. Add custom service methods to {@link servizio.prenotazione.aule.servizi.mef.service.impl.StrumEventoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
