 ...
 */
@ProviderType
public class StrumEventoPK implements Comparable<StrumEventoPK>, Serializable {
	public long id_strum;
	public long id_sala;

	public StrumEventoPK() {
	}

	public StrumEventoPK(long id_strum, long id_sala) {
	...
	@Override
	public int compareTo(StrumEventoPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof StrumEventoPK)) {
			return false;
		}

		StrumEventoPK pk = (StrumEventoPK)obj;
