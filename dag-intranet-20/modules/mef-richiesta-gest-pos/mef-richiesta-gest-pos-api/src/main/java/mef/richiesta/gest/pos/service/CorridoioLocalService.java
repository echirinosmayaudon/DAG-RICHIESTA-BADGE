...
/**
 * Provides the local service interface for Corridoio. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CorridoioLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CorridoioLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CorridoioLocalServiceUtil} to access the corridoio local service. Add custom service methods to <code>mef.richiesta.gest.pos.service.impl.CorridoioLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
