...
/**
 * Provides the local service interface for Piano. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PianoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PianoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PianoLocalServiceUtil} to access the piano local service. Add custom service methods to <code>mef.richiesta.gest.pos.service.impl.PianoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
