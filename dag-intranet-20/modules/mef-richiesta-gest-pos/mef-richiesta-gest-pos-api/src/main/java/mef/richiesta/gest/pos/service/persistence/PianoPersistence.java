...
/**
 * The persistence interface for the piano service.
 *
 * <p>
 ...
 */
@ProviderType
public interface PianoPersistence extends BasePersistence<Piano> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PianoUtil} to access the piano persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	@Override
	 ...
	 */
	public void cacheResult(java.util.List<Piano> pianos);
	 ...
	 * @throws NoSuchPianoException if a piano with the primary key could not be found
	 */
	public Piano findByPrimaryKey(long id_pk_piano) throws NoSuchPianoException;
	 ...
	 * @return the pianos
	 */
	public java.util.List<Piano> findAll();
	 ...
	 */
	public java.util.List<Piano> findAll(int start, int end);
	...
	public java.util.List<Piano> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Piano>
			orderByComparator);
