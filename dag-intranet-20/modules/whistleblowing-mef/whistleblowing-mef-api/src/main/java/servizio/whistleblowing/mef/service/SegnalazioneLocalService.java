...
/**
 * Provides the local service interface for Segnalazione. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SegnalazioneLocalServiceUtil
...
public interface SegnalazioneLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SegnalazioneLocalServiceUtil} to access the segnalazione local service. Add custom service methods to {@link servizio.whistleblowing.mef.service.impl.SegnalazioneLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
