...
@XmlRootElement(name = "associaTag")
public class AssociaTag {

    @XmlElementRef(name = "codStruttura", namespace = "http://services.rubrica.intranetdag.it", type = JAXBElement.class, required = false)
    protected JAXBElement<String> codStruttura;
    @XmlElementRef(name = "tag", namespace = "http://services.rubrica.intranetdag.it", type = JAXBElement.class, required = false)
