...
@XmlRootElement(name = "getListTagForChar")
public class GetListTagForChar {

    @XmlElementRef(name = "character", namespace = "http://services.rubrica.intranetdag.it", type = JAXBElement.class, required = false)
