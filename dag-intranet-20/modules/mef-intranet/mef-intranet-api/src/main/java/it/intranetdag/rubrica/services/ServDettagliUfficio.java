...
@XmlRootElement(name = "servDettagliUfficio")
public class ServDettagliUfficio {

    @XmlElementRef(name = "idUfficio", namespace = "http://services.rubrica.intranetdag.it", type = JAXBElement.class, required = false)
