...
import servizio.local.bfc.service.LocalRichService;
...
/**
 * Provides the base implementation for the local rich remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link servizio.local.bfc.service.impl.LocalRichServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LocalRichServiceBaseImpl extends BaseServiceImpl
	implements LocalRichService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link servizio.local.bfc.service.LocalRichServiceUtil} to access the local rich remote service.
	 */
	...
	public void setLocalRichInfoService(
		servizio.local.bfc.service.LocalRichInfoService localRichInfoService) {
	...
	@BeanReference(type = LocalRichService.class)
	protected LocalRichService localRichService;
	...
	@BeanReference(type = servizio.local.bfc.service.LocalRichInfoService.class)
	protected servizio.local.bfc.service.LocalRichInfoService localRichInfoService;
