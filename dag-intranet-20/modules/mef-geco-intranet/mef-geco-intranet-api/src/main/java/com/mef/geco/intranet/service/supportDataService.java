...
/**
 * Provides the remote service interface for supportData. Methods of this
...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=mefgeco", "json.web.service.context.path=supportData"}, service = supportDataService.class)
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface supportDataService extends BaseService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link supportDataServiceUtil} to access the support data remote service. Add custom service methods to {@link com.mef.geco.intranet.service.impl.supportDataServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
