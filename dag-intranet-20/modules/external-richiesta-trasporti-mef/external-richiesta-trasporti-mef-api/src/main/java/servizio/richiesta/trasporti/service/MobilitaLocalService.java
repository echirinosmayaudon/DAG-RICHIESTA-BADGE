...
/**
 * Provides the local service interface for Mobilita. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MobilitaLocalServiceUtil
...
public interface MobilitaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MobilitaLocalServiceUtil} to access the mobilita local service. Add custom service methods to {@link servizio.richiesta.trasporti.service.impl.MobilitaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Mobilita> getMobilitas(int start, int end);
	...
	*/
	...
	public Mobilita addMobilita(Mobilita mobilita);
	...
	*/
	public Mobilita createMobilita(java.lang.String custom_key);
	...
	*/
	...
	public Mobilita deleteMobilita(java.lang.String custom_key)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Mobilita deleteMobilita(Mobilita mobilita);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Mobilita fetchMobilita(java.lang.String custom_key);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Mobilita getMobilita(java.lang.String custom_key)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public Mobilita updateMobilita(Mobilita mobilita);
