...
/**
 * Provides the local service interface for RICHIESTA_RIMBORSO. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RICHIESTA_RIMBORSOLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RICHIESTA_RIMBORSOLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RICHIESTA_RIMBORSOLocalServiceUtil} to access the richiesta_rimborso local service. Add custom service methods to <code>mef.richieste.figli.service.impl.RICHIESTA_RIMBORSOLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
