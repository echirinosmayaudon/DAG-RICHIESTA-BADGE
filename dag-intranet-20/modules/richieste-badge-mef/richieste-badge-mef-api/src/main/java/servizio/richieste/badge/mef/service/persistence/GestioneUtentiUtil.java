...
public class GestioneUtentiUtil {
	...
	*/
	public static GestioneUtenti create(long id_gest_utenti) {
		return getPersistence().create(id_gest_utenti);
	}
	...
	*/
	public static GestioneUtenti remove(long id_gest_utenti)
		throws servizio.richieste.badge.mef.exception.NoSuchGestioneUtentiException {
		return getPersistence().remove(id_gest_utenti);
	}
	...
	* @throws NoSuchGestioneUtentiException if a gestione utenti with the primary key could not be found
	*/
	public static GestioneUtenti findByPrimaryKey(long id_gest_utenti)
		throws servizio.richieste.badge.mef.exception.NoSuchGestioneUtentiException {
		return getPersistence().findByPrimaryKey(id_gest_utenti);
	}
	...
	*/
	public static GestioneUtenti fetchByPrimaryKey(long id_gest_utenti) {
		return getPersistence().fetchByPrimaryKey(id_gest_utenti);
	}
