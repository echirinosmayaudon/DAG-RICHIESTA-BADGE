...
/**
 * Provides the local service interface for SediEsterne. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SediEsterneLocalServiceUtil
...
public interface SediEsterneLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SediEsterneLocalServiceUtil} to access the sedi esterne local service. Add custom service methods to {@link servizio.richieste.badge.mef.service.impl.SediEsterneLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SediEsterne> getSediEsterneByAcronimoSede(
