...
/**
 * Provides the local service interface for StatoRichiesta. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see StatoRichiestaLocalServiceUtil
...
public interface StatoRichiestaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StatoRichiestaLocalServiceUtil} to access the stato richiesta local service. Add custom service methods to {@link servizio.richieste.badge.mef.service.impl.StatoRichiestaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public List<StatoRichiesta> findStatoByDescrizione(
