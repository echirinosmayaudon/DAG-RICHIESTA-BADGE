...
import servizio.richieste.badge.mef.model.impl.GestioneUtentiImpl;
import servizio.richieste.badge.mef.model.impl.GestioneUtentiModelImpl;
 ...
 * @see servizio.richieste.badge.mef.service.persistence.GestioneUtentiUtil
 * @generated
 */
@ProviderType
public class GestioneUtentiPersistenceImpl extends BasePersistenceImpl<GestioneUtenti>
	...
	public GestioneUtenti create(long id_gest_utenti) {
		...
		gestioneUtenti.setPrimaryKey(id_gest_utenti);
	...
	public GestioneUtenti remove(long id_gest_utenti)
		...
		return remove((Serializable)id_gest_utenti);
	}
	...
	protected GestioneUtenti toUnwrappedModel(GestioneUtenti gestioneUtenti) {
		...
		gestioneUtentiImpl.setId_gest_utenti(gestioneUtenti.getId_gest_utenti());
		gestioneUtentiImpl.setData(gestioneUtenti.getData());
		gestioneUtentiImpl.setScreename_dirigente(gestioneUtenti.getScreename_dirigente());
		gestioneUtentiImpl.setScreename_utente(gestioneUtenti.getScreename_utente());
		gestioneUtentiImpl.setId_ufficio(gestioneUtenti.getId_ufficio());
	...
	public GestioneUtenti findByPrimaryKey(long id_gest_utenti)
		throws NoSuchGestioneUtentiException {
		return findByPrimaryKey((Serializable)id_gest_utenti);
	}
	...
	public GestioneUtenti fetchByPrimaryKey(long id_gest_utenti) {
		return fetchByPrimaryKey((Serializable)id_gest_utenti);
	}
	...
	private static final String _SQL_SELECT_GESTIONEUTENTI_WHERE_PKS_IN = "SELECT gestioneUtenti FROM GestioneUtenti gestioneUtenti WHERE id_gest_utenti IN (";
