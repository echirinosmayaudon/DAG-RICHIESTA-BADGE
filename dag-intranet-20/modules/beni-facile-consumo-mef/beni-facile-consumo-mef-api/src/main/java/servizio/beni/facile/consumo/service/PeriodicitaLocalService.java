...
/**
 * Provides the local service interface for Periodicita. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PeriodicitaLocalServiceUtil
...
public interface PeriodicitaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PeriodicitaLocalServiceUtil} to access the periodicita local service. Add custom service methods to {@link servizio.beni.facile.consumo.service.impl.PeriodicitaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Periodicita> getPeriodicitas(int start, int end);
	...
	*/
	...
	public Periodicita addPeriodicita(Periodicita periodicita);
	...
	*/
	public Periodicita createPeriodicita(long id);
	...
	*/
	...
	public Periodicita deletePeriodicita(long id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Periodicita deletePeriodicita(Periodicita periodicita);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Periodicita fetchPeriodicita(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Periodicita getPeriodicita(long id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public Periodicita updatePeriodicita(Periodicita periodicita);
}