...
/**
 * Provides the local service interface for Stato. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see StatoLocalServiceUtil
...
public interface StatoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StatoLocalServiceUtil} to access the stato local service. Add custom service methods to {@link servizio.beni.facile.consumo.service.impl.StatoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Stato> getStatos(int start, int end);
	...
	*/
	...
	public Stato addStato(Stato stato);
	...
	*/
	public Stato createStato(long id);
	...
	*/
	...
	public Stato deleteStato(long id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Stato deleteStato(Stato stato);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Stato fetchStato(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Stato getStato(long id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public Stato updateStato(Stato stato);
}