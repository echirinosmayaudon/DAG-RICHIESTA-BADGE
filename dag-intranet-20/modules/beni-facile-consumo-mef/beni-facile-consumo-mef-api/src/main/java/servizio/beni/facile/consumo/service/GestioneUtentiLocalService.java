...
public interface GestioneUtentiLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GestioneUtentiLocalServiceUtil} to access the gestione utenti local service. Add custom service methods to {@link servizio.beni.facile.consumo.service.impl.GestioneUtentiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public boolean insertGestioneUtenti(java.lang.String codiceFiscale,
		java.lang.String nome, java.lang.String cognome, Date data,
		java.lang.String ufficio, java.lang.String btnAction, User utente,
		long companyId);
	...
	*/
	public GestioneUtenti createGestioneUtenti(long id);
	...
	*/
	...
	public GestioneUtenti deleteGestioneUtenti(long id)
		throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public GestioneUtenti fetchGestioneUtenti(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public GestioneUtenti getGestioneUtenti(long id) throws PortalException;
