...
/**
 * Provides the local service interface for CambioStatoDirigente. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CambioStatoDirigenteLocalServiceUtil
...
public interface CambioStatoDirigenteLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CambioStatoDirigenteLocalServiceUtil} to access the cambio stato dirigente local service. Add custom service methods to {@link servizio.beni.facile.consumo.service.impl.CambioStatoDirigenteLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public boolean insertCambioStatoDirigente(long id_rich, long id_stato,
		Date data, java.lang.String note, java.lang.String nomeutente);
