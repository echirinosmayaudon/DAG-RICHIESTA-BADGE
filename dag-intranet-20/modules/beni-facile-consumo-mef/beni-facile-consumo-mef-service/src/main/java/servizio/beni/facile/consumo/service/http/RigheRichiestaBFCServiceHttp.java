 ...
 * @see RigheRichiestaBFCServiceSoap
 * @see HttpPrincipal
 * @see RigheRichiestaBFCServiceUtil
 * @generated
 */
@ProviderType
public class RigheRichiestaBFCServiceHttp {
	public static java.util.List<servizio.beni.facile.consumo.model.RigheRichiestaBFC> getRigheRichiestaByDipartimento(
		...
		try {
			MethodKey methodKey = new MethodKey(RigheRichiestaBFCServiceUtil.class,
			...
			return (java.util.List<servizio.beni.facile.consumo.model.RigheRichiestaBFC>)returnObj;
		}
	...
	private static Log _log = LogFactoryUtil.getLog(RigheRichiestaBFCServiceHttp.class);
