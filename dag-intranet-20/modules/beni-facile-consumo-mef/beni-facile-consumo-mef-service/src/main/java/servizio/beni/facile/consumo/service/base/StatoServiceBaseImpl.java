...
import servizio.beni.facile.consumo.service.StatoService;
...
/**
 * Provides the base implementation for the stato remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link servizio.beni.facile.consumo.service.impl.StatoServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class StatoServiceBaseImpl extends BaseServiceImpl
	implements StatoService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link servizio.beni.facile.consumo.service.StatoServiceUtil} to access the stato remote service.
	 */
	 ...
	 */
	public StatoService getStatoService() {
		return statoService;
	}
	 ...
	 */
	public void setStatoService(StatoService statoService) {
	...
	public String getOSGiServiceIdentifier() {
		return StatoService.class.getName();
	}
	...
	@BeanReference(type = StatoService.class)
