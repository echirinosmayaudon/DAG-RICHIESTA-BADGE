...
public class PDFCustomTableCell {
	...
	private float heightTextPDF = this.getMinHeight();
	...
	public float getHeightTextPDF() {
		return heightTextPDF;
	}



	public void setHeightTextPDF(float heightTextPDF) {
		this.heightTextPDF = heightTextPDF;
	}
	...
	public PDFCustomTableCell(String text){
		if (text != null) {
			...
			this.listText = new ArrayList<>(0);
			this.listText.add(text);
			this.textPDF = new ArrayList<>(0);
	...
	private float getCenterTextHeight(float position) {
		...
		float space = (this.heightTextPDF / (this.getTextPDF().size()));
	...
	public void setTextPDF()  {
		...
		this.heightTextPDF = (this.getMinHeight() * textPDF.size());
