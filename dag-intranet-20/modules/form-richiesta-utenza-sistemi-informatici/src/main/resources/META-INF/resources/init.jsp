...
<%@page import="form.richiesta.utenza.sistemi.informatici.portlet.FormRichiestaUtenzaConfig"%>
...
FormRichiestaUtenzaConfig richiestaMefConfig = (FormRichiestaUtenzaConfig) renderRequest.getAttribute(FormRichiestaUtenzaConfig.class.getName());
