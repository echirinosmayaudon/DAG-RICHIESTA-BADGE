...
import mef.email.configurator.service.EmailAppService;
...
/**
 * Provides the base implementation for the email app remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link mef.email.configurator.service.impl.EmailAppServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class EmailAppServiceBaseImpl extends BaseServiceImpl
	implements EmailAppService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link mef.email.configurator.service.EmailAppServiceUtil} to access the email app remote service.
	 */
	 ...
	 */
	public mef.email.configurator.service.AppNamesService getAppNamesService() {
	 ...
	 */
	public void setAppNamesService(
		mef.email.configurator.service.AppNamesService appNamesService) {
	 ...
	 */
	public EmailAppService getEmailAppService() {
	 ...
	 */
	public void setEmailAppService(EmailAppService emailAppService) {
	...
	public String getOSGiServiceIdentifier() {
		return EmailAppService.class.getName();
	}
	...
	@BeanReference(type = mef.email.configurator.service.AppNamesService.class)
	protected mef.email.configurator.service.AppNamesService appNamesService;
	...
	@BeanReference(type = EmailAppService.class)
	protected EmailAppService emailAppService;
