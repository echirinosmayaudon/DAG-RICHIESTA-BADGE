...
/**
 * Provides the local service interface for EmailApp. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EmailAppLocalServiceUtil
...
public interface EmailAppLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmailAppLocalServiceUtil} to access the email app local service. Add custom service methods to {@link mef.email.configurator.service.impl.EmailAppLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EmailApp> getEmailByAppIdAndStructureId(long appId,
		long structureId);
