...
import external.bfc.intranet.mef.service.RichiesteService;
...
/**
 * Provides the base implementation for the richieste remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link external.bfc.intranet.mef.service.impl.RichiesteServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class RichiesteServiceBaseImpl extends BaseServiceImpl
	implements RichiesteService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link external.bfc.intranet.mef.service.RichiesteServiceUtil} to access the richieste remote service.
	 */
	 ...
	 */
	public RichiesteService getRichiesteService() {
	 ...
	 */
	public void setRichiesteService(RichiesteService richiesteService) {
	...
	public String getOSGiServiceIdentifier() {
		return RichiesteService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = richiestePersistence.getDataSource();
	...
	@BeanReference(type = RichiesteService.class)
	protected RichiesteService richiesteService;
