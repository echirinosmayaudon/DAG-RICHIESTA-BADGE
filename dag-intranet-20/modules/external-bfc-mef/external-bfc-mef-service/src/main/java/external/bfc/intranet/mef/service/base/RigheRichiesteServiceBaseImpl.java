...
import external.bfc.intranet.mef.service.RigheRichiesteService;
...
/**
 * Provides the base implementation for the righe richieste remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link external.bfc.intranet.mef.service.impl.RigheRichiesteServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class RigheRichiesteServiceBaseImpl extends BaseServiceImpl
	implements RigheRichiesteService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link external.bfc.intranet.mef.service.RigheRichiesteServiceUtil} to access the righe richieste remote service.
	 */
	 ...
	 */
	public RigheRichiesteService getRigheRichiesteService() {
	...
	public String getOSGiServiceIdentifier() {
		return RigheRichiesteService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = righeRichiestePersistence.getDataSource();
	...
	@BeanReference(type = RigheRichiesteService.class)
	protected RigheRichiesteService righeRichiesteService;
