...
/**
 * Provides the local service interface for RigheRichiesteInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RigheRichiesteInfoLocalServiceUtil
...
public interface RigheRichiesteInfoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RigheRichiesteInfoLocalServiceUtil} to access the righe richieste info local service. Add custom service methods to {@link external.bfc.intranet.mef.service.impl.RigheRichiesteInfoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RigheRichiesteInfo> getrichiesteInfoId(long id);
