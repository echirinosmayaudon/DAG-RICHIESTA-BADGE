 ...
 */
@ProviderType
public class RigheRichiestePK implements Comparable<RigheRichiestePK>,
	Serializable {
	public long id;
	...
	public RigheRichiestePK() {
	}

	public RigheRichiestePK(long id, long idMateriale, String sottogruppo,
		String gruppo) {
		this.id = id;
	...
	@Override
	public int compareTo(RigheRichiestePK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RigheRichiestePK)) {
			return false;
		}

		RigheRichiestePK pk = (RigheRichiestePK)obj;
