...
/**
 * This class is used by SOAP remote services, specifically {@link external.bfc.intranet.mef.service.http.RigheRichiesteServiceSoap}.
 *
 * @author Brian Wing Shun Chan
 * @see external.bfc.intranet.mef.service.http.RigheRichiesteServiceSoap
 * @generated
 */
@ProviderType
public class RigheRichiesteSoap implements Serializable {
	public static RigheRichiesteSoap toSoapModel(RigheRichieste model) {
		RigheRichiesteSoap soapModel = new RigheRichiesteSoap();
	...
	public static RigheRichiesteSoap[] toSoapModels(RigheRichieste[] models) {
		RigheRichiesteSoap[] soapModels = new RigheRichiesteSoap[models.length];
	...
	public static RigheRichiesteSoap[][] toSoapModels(RigheRichieste[][] models) {
		RigheRichiesteSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new RigheRichiesteSoap[models.length][models[0].length];
		}
		else {
			soapModels = new RigheRichiesteSoap[0][0];
		}
	...
	public static RigheRichiesteSoap[] toSoapModels(List<RigheRichieste> models) {
		List<RigheRichiesteSoap> soapModels = new ArrayList<RigheRichiesteSoap>(models.size());

		for (RigheRichieste model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new RigheRichiesteSoap[soapModels.size()]);
	}

	public RigheRichiesteSoap() {
	}
	...
	public void setPrimaryKey(RigheRichiestePK pk) {
		setId(pk.id);
