...
/**
 * Provides the local service interface for Richieste. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RichiesteLocalServiceUtil
...
public interface RichiesteLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RichiesteLocalServiceUtil} to access the richieste local service. Add custom service methods to {@link external.bfc.intranet.mef.service.impl.RichiesteLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Richieste addRichieste(Richieste richieste);
	...
	*/
	public Richieste createRichieste(long id);
	...
	*/
	...
	public Richieste deleteRichieste(Richieste richieste);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Richieste deleteRichieste(long id) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Richieste fetchRichieste(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Richieste getRichieste(long id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public Richieste updateRichieste(Richieste richieste);
	...
	*/
	...
	public List<Richieste> findByfilters(List<java.lang.Long> lista_stati,
		List<java.lang.String> ufficio, List<User> lista_utenti);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Richieste> getRichiestebyEmail(java.lang.String email);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Richieste> getRichiestes(int start, int end);
