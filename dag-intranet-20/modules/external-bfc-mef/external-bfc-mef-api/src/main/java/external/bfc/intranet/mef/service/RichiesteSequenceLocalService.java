...
/**
 * Provides the local service interface for RichiesteSequence. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RichiesteSequenceLocalServiceUtil
...
public interface RichiesteSequenceLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RichiesteSequenceLocalServiceUtil} to access the richieste sequence local service. Add custom service methods to {@link external.bfc.intranet.mef.service.impl.RichiesteSequenceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
