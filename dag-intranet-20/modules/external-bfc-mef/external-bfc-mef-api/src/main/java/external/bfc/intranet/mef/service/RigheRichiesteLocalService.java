...
/**
 * Provides the local service interface for RigheRichieste. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RigheRichiesteLocalServiceUtil
...
public interface RigheRichiesteLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RigheRichiesteLocalServiceUtil} to access the righe richieste local service. Add custom service methods to {@link external.bfc.intranet.mef.service.impl.RigheRichiesteLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public RigheRichieste addRigheRichieste(RigheRichieste righeRichieste);
	...
	*/
	public RigheRichieste createRigheRichieste(
		RigheRichiestePK righeRichiestePK);
	...
	*/
	...
	public RigheRichieste deleteRigheRichieste(RigheRichieste righeRichieste);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public RigheRichieste deleteRigheRichieste(
		RigheRichiestePK righeRichiestePK) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RigheRichieste fetchRigheRichieste(RigheRichiestePK righeRichiestePK);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RigheRichieste getRigheRichieste(RigheRichiestePK righeRichiestePK)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public RigheRichieste updateRigheRichieste(RigheRichieste righeRichieste);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RigheRichieste> getRigheRichiestes(int start, int end);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RigheRichieste> getrichiesteId(long id);
