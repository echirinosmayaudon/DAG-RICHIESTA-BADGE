...
public class EmailSender {
	 ...
	 final Log _log = LogFactoryUtil.getLog(EmailSender.class);
	  ...
	  public boolean sendMailMessage(String mailSubject, String mailBody, String senderName, String senderMailAddress, List<String> receiverMailAddressList, List<String> ccMailAddressList, List<File> fileAllegatiList) {
		  try {			  
