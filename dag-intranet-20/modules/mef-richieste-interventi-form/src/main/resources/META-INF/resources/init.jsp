...
<%@page import="mef.richieste.interventi.portlet.MefRichiesteInterventiConfig"%>
...
MefRichiesteInterventiConfig richiestaMefConfig = (MefRichiesteInterventiConfig) renderRequest.getAttribute(MefRichiesteInterventiConfig.class.getName());
