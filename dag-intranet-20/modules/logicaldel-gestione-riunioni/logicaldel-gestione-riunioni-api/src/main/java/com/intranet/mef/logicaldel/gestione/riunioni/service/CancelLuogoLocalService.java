...
/**
 * Provides the local service interface for CancelLuogo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CancelLuogoLocalServiceUtil
...
public interface CancelLuogoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CancelLuogoLocalServiceUtil} to access the cancel luogo local service. Add custom service methods to {@link com.intranet.mef.logicaldel.gestione.riunioni.service.impl.CancelLuogoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
