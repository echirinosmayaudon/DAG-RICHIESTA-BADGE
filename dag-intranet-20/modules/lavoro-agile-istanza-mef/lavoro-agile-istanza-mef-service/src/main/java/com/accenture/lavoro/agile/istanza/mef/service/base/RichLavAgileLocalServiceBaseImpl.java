...
import com.accenture.lavoro.agile.istanza.mef.service.RichLavAgileLocalService;
...
/**
 * Provides the base implementation for the rich lav agile local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.accenture.lavoro.agile.istanza.mef.service.impl.RichLavAgileLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class RichLavAgileLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RichLavAgileLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.accenture.lavoro.agile.istanza.mef.service.RichLavAgileLocalServiceUtil} to access the rich lav agile local service.
	 */
	...
	public RichLavAgile addRichLavAgile(RichLavAgile richLavAgile) {
		...
		return richLavAgilePersistence.update(richLavAgile);
	}
	...
	public RichLavAgile createRichLavAgile(long id) {
		return richLavAgilePersistence.create(id);
	}
	...
	public RichLavAgile deleteRichLavAgile(long id) throws PortalException {
		return richLavAgilePersistence.remove(id);
	}
	...
	public RichLavAgile deleteRichLavAgile(RichLavAgile richLavAgile) {
		return richLavAgilePersistence.remove(richLavAgile);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RichLavAgile.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return richLavAgilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return richLavAgilePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public RichLavAgile fetchRichLavAgile(long id) {
		return richLavAgilePersistence.fetchByPrimaryKey(id);
	}
	...
	public RichLavAgile getRichLavAgile(long id) throws PortalException {
		return richLavAgilePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(richLavAgileLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(RichLavAgile.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(richLavAgileLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(RichLavAgile.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return richLavAgileLocalService.deleteRichLavAgile((RichLavAgile)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return richLavAgilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<RichLavAgile> getRichLavAgiles(int start, int end) {
		return richLavAgilePersistence.findAll(start, end);
	}
	...
	public int getRichLavAgilesCount() {
		return richLavAgilePersistence.countAll();
	}
	 ...
	 */
	public RichLavAgileLocalService getRichLavAgileLocalService() {
	...
	public void setRichLavAgileLocalService(
		RichLavAgileLocalService richLavAgileLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.accenture.lavoro.agile.istanza.mef.model.RichLavAgile",
			richLavAgileLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.accenture.lavoro.agile.istanza.mef.model.RichLavAgile");
	}
	...
	public String getOSGiServiceIdentifier() {
		return RichLavAgileLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = richLavAgilePersistence.getDataSource();
	...
	@BeanReference(type = RichLavAgileLocalService.class)
	protected RichLavAgileLocalService richLavAgileLocalService;
