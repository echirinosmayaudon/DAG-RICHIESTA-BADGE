...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=mefistagile", "json.web.service.context.path=Email"}, service = EmailService.class)
@ProviderType
...
public interface EmailService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmailServiceUtil} to access the email remote service. Add custom service methods to {@link com.accenture.lavoro.agile.istanza.mef.service.impl.EmailServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
