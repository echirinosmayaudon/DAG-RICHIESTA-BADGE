...
/**
 * Provides the local service interface for RichLavAgile. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RichLavAgileLocalServiceUtil
...
public interface RichLavAgileLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RichLavAgileLocalServiceUtil} to access the rich lav agile local service. Add custom service methods to {@link com.accenture.lavoro.agile.istanza.mef.service.impl.RichLavAgileLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public RichLavAgile addRichLavAgile(RichLavAgile richLavAgile);
	...
	*/
	...
	public RichLavAgile createRichLavAgile(long id);
	...
	*/
	...
	public RichLavAgile deleteRichLavAgile(long id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public RichLavAgile deleteRichLavAgile(RichLavAgile richLavAgile);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RichLavAgile fetchRichLavAgile(long id);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RichLavAgile> getRichiesteOrder(String order,
		long codiceIstanza, String cognome, long dip, long dir, long uff);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RichLavAgile getRichLavAgile(long id) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RichLavAgile> getRichLavAgiles(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public int getRichLavAgilesCount();

	public long insertRichiestaAgile(long id_richiesta, String cognome,
		String nome, long dipartimento, long direzione, long ufficio,
		String screename, String jsonRichiedente, String jsonRichiesta,
		int peso_tot, String peso_plus, String bando, Date data_richiesta,
		String allegato, String pdf);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public RichLavAgile updateRichLavAgile(RichLavAgile richLavAgile);
}