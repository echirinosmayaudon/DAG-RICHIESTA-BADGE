...
/**
 * Provides the local service interface for RichInterpello. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RichInterpelloLocalServiceUtil
...
public interface RichInterpelloLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RichInterpelloLocalServiceUtil} to access the rich interpello local service. Add custom service methods to {@link com.accenture.istanza.interpello.service.impl.RichInterpelloLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RichInterpello> getRichiesteOrder(String order,
	...
	*/
	...
	public long insertRichiestaInterpello(long id_richiesta, String cognome,
		String nome, long dipartimento, long direzione, long ufficio,
		String screename, String jsonRichiedente, String jsonRichiesta,
		String bando, Date data_richiesta, String allegato, String pdf,
		String note);
