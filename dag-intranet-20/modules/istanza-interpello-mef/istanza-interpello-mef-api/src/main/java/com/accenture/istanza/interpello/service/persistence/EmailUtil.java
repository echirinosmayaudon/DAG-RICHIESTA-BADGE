 ...
 * @see com.accenture.istanza.interpello.service.persistence.impl.EmailPersistenceImpl
 * @generated
 */
@ProviderType
public class EmailUtil {
	...
	*/
	public static Email findByIdStruttura_First(long idStruttura,
		...
		throws com.accenture.istanza.interpello.exception.NoSuchEmailException {
		return getPersistence()
