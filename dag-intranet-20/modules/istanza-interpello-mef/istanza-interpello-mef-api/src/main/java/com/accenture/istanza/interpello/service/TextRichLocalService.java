...
/**
 * Provides the local service interface for TextRich. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TextRichLocalServiceUtil
...
public interface TextRichLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TextRichLocalServiceUtil} to access the text rich local service. Add custom service methods to {@link com.accenture.istanza.interpello.service.impl.TextRichLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
