...
/**
 * Provides the local service interface for WebContentConfig. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see WebContentConfigLocalServiceUtil
...
public interface WebContentConfigLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WebContentConfigLocalServiceUtil} to access the web content config local service. Add custom service methods to {@link mef.webcontent.config.service.impl.WebContentConfigLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
