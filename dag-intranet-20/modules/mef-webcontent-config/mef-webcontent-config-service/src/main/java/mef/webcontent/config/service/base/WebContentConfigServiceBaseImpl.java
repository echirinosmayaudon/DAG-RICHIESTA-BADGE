...
import mef.webcontent.config.service.WebContentConfigService;
import mef.webcontent.config.service.persistence.WebContentConfigPersistence;

import javax.sql.DataSource;

/**
 * Provides the base implementation for the web content config remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link mef.webcontent.config.service.impl.WebContentConfigServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class WebContentConfigServiceBaseImpl extends BaseServiceImpl
	implements WebContentConfigService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link mef.webcontent.config.service.WebContentConfigServiceUtil} to access the web content config remote service.
	 */
	 ...
	 */
	public mef.webcontent.config.service.WebContentConfigLocalService getWebContentConfigLocalService() {
	...
	public void setWebContentConfigLocalService(
		mef.webcontent.config.service.WebContentConfigLocalService webContentConfigLocalService) {
		this.webContentConfigLocalService = webContentConfigLocalService;
	}

	/**
	 * Returns the web content config remote service.
	 *
	 * @return the web content config remote service
	 */
	public WebContentConfigService getWebContentConfigService() {
		return webContentConfigService;
	}

	/**
	 * Sets the web content config remote service.
	 *
	 * @param webContentConfigService the web content config remote service
	 */
	...
	public String getOSGiServiceIdentifier() {
		return WebContentConfigService.class.getName();
	}
	...
	@BeanReference(type = mef.webcontent.config.service.WebContentConfigLocalService.class)
	protected mef.webcontent.config.service.WebContentConfigLocalService webContentConfigLocalService;
	@BeanReference(type = WebContentConfigService.class)
	protected WebContentConfigService webContentConfigService;
