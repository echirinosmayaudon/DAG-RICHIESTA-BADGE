...
@Component(configurationPid = "mef.richiestehw.portlet.MefRichiestehwConfig", configurationPolicy = ConfigurationPolicy.IGNORE, immediate = true, property = {
"javax.portlet.name=mef_richiestehw_portlet_MefRichiestehwPortlet" }, service = ConfigurationAction.class)
public class MefRichiestehwConfiguration  extends DefaultConfigurationAction{
	...
	public void include(PortletConfig portletConfig, HttpServletRequest httpServletRequest,
		...
		httpServletRequest.setAttribute(MefRichiestehwConfig.class.getName(), _configuration);
