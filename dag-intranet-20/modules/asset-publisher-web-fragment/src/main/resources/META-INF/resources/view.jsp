...
//settaggio parametri keywords e categories nella portlerURL
StringBuilder keywordsString = new StringBuilder();
if (!Validator.isBlank(keywords)) {
                portletURL.setParameter("keywords", keywords);
                keywordsString.append(keywords);
}
...
if (Validator.isNotNull(categories)) {
                ...
                portletURL.setParameter("categories", categoriesString.toString());
}
//fine settaggio
...
<input class="searchTotal" type="hidden" value="<%=searchContainer.getTotal()%>"></input>
<input class="inputKeywords" type="hidden" value="<%=keywordsString.toString()%>"></input>
<input class="inputCategories" type="hidden" value="<%=categoriesString.toString()%>"></input> 
