...
String viewURL = it.smc.mef.assetpublisher.fragment.util.CustomAssetPublisherHelper.getAssetViewURL(liferayPortletRequest, liferayPortletResponse, assetEntry, viewInContext);
%>
