...
/**
 * Provides the local service interface for Donatore. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DonatoreLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DonatoreLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DonatoreLocalServiceUtil} to access the donatore local service. Add custom service methods to <code>form.service.contributo.solidarieta.service.impl.DonatoreLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public Donatore addDonatore(Donatore donatore);

	public Donatore creaDonatore(
	...
	public Donatore createDonatore(long id);
	...
	public Donatore deleteDonatore(Donatore donatore);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Donatore deleteDonatore(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Donatore fetchDonatore(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Donatore getDonatore(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Donatore> getDonatores(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Donatore updateDonatore(Donatore donatore);
