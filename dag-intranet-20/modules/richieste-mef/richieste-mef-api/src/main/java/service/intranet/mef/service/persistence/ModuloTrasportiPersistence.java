...
/**
 * The persistence interface for the modulo trasporti service.
 *
 * <p>
 ...
 * @see ModuloTrasportiUtil
 * @generated
 */
@ProviderType
public interface ModuloTrasportiPersistence extends BasePersistence<ModuloTrasporti> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ModuloTrasportiUtil} to access the modulo trasporti persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(java.util.List<ModuloTrasporti> moduloTrasportis);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, ModuloTrasporti> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<ModuloTrasporti> findAll();
	...
	*/
	public java.util.List<ModuloTrasporti> findAll(int start, int end);
	...
	*/
	public java.util.List<ModuloTrasporti> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ModuloTrasporti> orderByComparator);
