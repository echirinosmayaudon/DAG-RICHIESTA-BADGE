...
/**
 * Provides the local service interface for BeneInv. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BeneInvLocalServiceUtil
...
public interface BeneInvLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BeneInvLocalServiceUtil} to access the bene inv local service. Add custom service methods to {@link service.intranet.mef.service.impl.BeneInvLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<BeneInv> getBeneInvs(int start, int end);
	...
	*/
	...
	public BeneInv addBeneInv(BeneInv beneInv);
	...
	*/
	public BeneInv createBeneInv(long id);
	...
	*/
	...
	public BeneInv deleteBeneInv(long id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public BeneInv deleteBeneInv(BeneInv beneInv);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public BeneInv fetchBeneInv(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public BeneInv getBeneInv(long id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public BeneInv updateBeneInv(BeneInv beneInv);
}