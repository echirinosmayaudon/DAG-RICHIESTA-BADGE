...
/**
 * Provides the local service interface for TipologiaStampanti. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TipologiaStampantiLocalServiceUtil
...
public interface TipologiaStampantiLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TipologiaStampantiLocalServiceUtil} to access the tipologia stampanti local service. Add custom service methods to {@link service.intranet.mef.service.impl.TipologiaStampantiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TipologiaStampanti> getTipologiaStampantis(int start, int end);
	...
	*/
	...
	public TipologiaStampanti addTipologiaStampanti(
	...
	*/
	public TipologiaStampanti createTipologiaStampanti(
	...
	*/
	...
	public TipologiaStampanti deleteTipologiaStampanti(
		long id_tipologia_stampanti) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TipologiaStampanti fetchTipologiaStampanti(
		long id_tipologia_stampanti);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TipologiaStampanti getTipologiaStampanti(long id_tipologia_stampanti)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public TipologiaStampanti updateTipologiaStampanti(
		TipologiaStampanti tipologiaStampanti);
}