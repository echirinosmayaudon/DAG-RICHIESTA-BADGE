 ...
 * @see service.intranet.mef.service.persistence.impl.AssetPersistenceImpl
 * @generated
 */
@ProviderType
public class AssetUtil {
	...
	*/
	public static Asset create(long id) {
	...
	*/
	public static Asset remove(long id)
		throws service.intranet.mef.exception.NoSuchAssetException {
	...
	* @throws NoSuchAssetException if a asset with the primary key could not be found
	*/
	public static Asset findByPrimaryKey(long id)
		throws service.intranet.mef.exception.NoSuchAssetException {
	...
	*/
	public static Asset fetchByPrimaryKey(long id) {
