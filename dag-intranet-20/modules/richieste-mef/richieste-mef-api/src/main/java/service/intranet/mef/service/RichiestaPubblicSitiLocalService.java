...
/**
 * Provides the local service interface for RichiestaPubblicSiti. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RichiestaPubblicSitiLocalServiceUtil
...
public interface RichiestaPubblicSitiLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RichiestaPubblicSitiLocalServiceUtil} to access the richiesta pubblic siti local service. Add custom service methods to {@link service.intranet.mef.service.impl.RichiestaPubblicSitiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RichiestaPubblicSiti> getRichiestaPubblicSitis(int start,
		int end);
	...
	*/
	...
	public RichiestaPubblicSiti addRichiestaPubblicSiti(
	...
	*/
	public RichiestaPubblicSiti createRichiestaPubblicSiti(long id_rich_pubblic);
	...
	*/
	...
	public RichiestaPubblicSiti deleteRichiestaPubblicSiti(long id_rich_pubblic)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public RichiestaPubblicSiti deleteRichiestaPubblicSiti(
		RichiestaPubblicSiti richiestaPubblicSiti);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RichiestaPubblicSiti fetchRichiestaPubblicSiti(long id_rich_pubblic);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RichiestaPubblicSiti getRichiestaPubblicSiti(long id_rich_pubblic)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public RichiestaPubblicSiti updateRichiestaPubblicSiti(
		RichiestaPubblicSiti richiestaPubblicSiti);
}