...
/**
 * Provides the local service interface for LogisticaValutazione. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LogisticaValutazioneLocalServiceUtil
...
public interface LogisticaValutazioneLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LogisticaValutazioneLocalServiceUtil} to access the logistica valutazione local service. Add custom service methods to {@link service.intranet.mef.service.impl.LogisticaValutazioneLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LogisticaValutazione> getLogisticaValutaziones(int start,
		int end);
	...
	*/
	...
	public LogisticaValutazione addLogisticaValutazione(
	...
	*/
	public LogisticaValutazione createLogisticaValutazione(long id);
	...
	*/
	...
	public LogisticaValutazione deleteLogisticaValutazione(long id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public LogisticaValutazione deleteLogisticaValutazione(
		LogisticaValutazione logisticaValutazione);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LogisticaValutazione fetchLogisticaValutazione(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LogisticaValutazione getLogisticaValutazione(long id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public LogisticaValutazione updateLogisticaValutazione(
		LogisticaValutazione logisticaValutazione);
}