...
/**
 * Provides the local service interface for TipologiaDispositivi. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TipologiaDispositiviLocalServiceUtil
...
public interface TipologiaDispositiviLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TipologiaDispositiviLocalServiceUtil} to access the tipologia dispositivi local service. Add custom service methods to {@link service.intranet.mef.service.impl.TipologiaDispositiviLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TipologiaDispositivi> getTipologiaDispositivis(int start,
		int end);
	...
	*/
	...
	public TipologiaDispositivi addTipologiaDispositivi(
	...
	*/
	public TipologiaDispositivi createTipologiaDispositivi(
	...
	*/
	...
	public TipologiaDispositivi deleteTipologiaDispositivi(
		long id_tipologia_dispositivi) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TipologiaDispositivi fetchTipologiaDispositivi(
		long id_tipologia_dispositivi);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TipologiaDispositivi getTipologiaDispositivi(
		long id_tipologia_dispositivi) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public TipologiaDispositivi updateTipologiaDispositivi(
		TipologiaDispositivi tipologiaDispositivi);
}