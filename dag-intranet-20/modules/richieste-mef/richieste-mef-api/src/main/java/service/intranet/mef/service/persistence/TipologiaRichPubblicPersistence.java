...
/**
 * The persistence interface for the tipologia rich pubblic service.
 *
 * <p>
 ...
 * @see TipologiaRichPubblicUtil
 * @generated
 */
@ProviderType
public interface TipologiaRichPubblicPersistence extends BasePersistence<TipologiaRichPubblic> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TipologiaRichPubblicUtil} to access the tipologia rich pubblic persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(
		java.util.List<TipologiaRichPubblic> tipologiaRichPubblics);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, TipologiaRichPubblic> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<TipologiaRichPubblic> findAll();
	...
	*/
	public java.util.List<TipologiaRichPubblic> findAll(int start, int end);
	...
	*/
	public java.util.List<TipologiaRichPubblic> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<TipologiaRichPubblic> orderByComparator);
