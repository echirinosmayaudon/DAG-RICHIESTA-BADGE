...
/**
 * Provides the local service utility for TipologiaComputer. This utility wraps
 * {@link service.intranet.mef.service.impl.TipologiaComputerLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class TipologiaComputerLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link service.intranet.mef.service.impl.TipologiaComputerLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static int getTipologiaComputersCount() {
		return getService().getTipologiaComputersCount();
	}
	...
	*/
	public static java.util.List<service.intranet.mef.model.TipologiaComputer> getTipologiaComputers(
		int start, int end) {
		return getService().getTipologiaComputers(start, end);
	}
	...
	*/
	public static service.intranet.mef.model.TipologiaComputer addTipologiaComputer(
		service.intranet.mef.model.TipologiaComputer tipologiaComputer) {
		return getService().addTipologiaComputer(tipologiaComputer);
	}
	...
	*/
	public static service.intranet.mef.model.TipologiaComputer createTipologiaComputer(
		long id_tipologia_computer) {
		return getService().createTipologiaComputer(id_tipologia_computer);
	}
	...
	*/
	public static service.intranet.mef.model.TipologiaComputer deleteTipologiaComputer(
		long id_tipologia_computer)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteTipologiaComputer(id_tipologia_computer);
	}
	...
	*/
	public static service.intranet.mef.model.TipologiaComputer deleteTipologiaComputer(
		service.intranet.mef.model.TipologiaComputer tipologiaComputer) {
		return getService().deleteTipologiaComputer(tipologiaComputer);
	}

	public static service.intranet.mef.model.TipologiaComputer fetchTipologiaComputer(
		long id_tipologia_computer) {
		return getService().fetchTipologiaComputer(id_tipologia_computer);
	}
	...
	* @throws PortalException if a tipologia computer with the primary key could not be found
	*/
	public static service.intranet.mef.model.TipologiaComputer getTipologiaComputer(
		long id_tipologia_computer)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getTipologiaComputer(id_tipologia_computer);
	}
	...
	*/
	public static service.intranet.mef.model.TipologiaComputer updateTipologiaComputer(
		service.intranet.mef.model.TipologiaComputer tipologiaComputer) {
		return getService().updateTipologiaComputer(tipologiaComputer);
	}

	public static TipologiaComputerLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<TipologiaComputerLocalService, TipologiaComputerLocalService> _serviceTracker =
		ServiceTrackerFactory.open(TipologiaComputerLocalService.class);
}