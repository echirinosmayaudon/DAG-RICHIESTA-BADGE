...
public class AssetLocalServiceWrapper implements AssetLocalService,
	...
	*/
	@Override
	public java.util.List<service.intranet.mef.model.Asset> getAssets(
		int start, int end) {
	...
	*/
	@Override
	public service.intranet.mef.model.Asset addAsset(
	...
	*/
	@Override
	public service.intranet.mef.model.Asset createAsset(long id) {
		return _assetLocalService.createAsset(id);
	}
	...
	*/
	@Override
	public service.intranet.mef.model.Asset deleteAsset(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _assetLocalService.deleteAsset(id);
	}
	...
	*/
	@Override
	public service.intranet.mef.model.Asset deleteAsset(
		service.intranet.mef.model.Asset asset) {
		return _assetLocalService.deleteAsset(asset);
	}

	@Override
	public service.intranet.mef.model.Asset fetchAsset(long id) {
		return _assetLocalService.fetchAsset(id);
	}
	...
	*/
	@Override
	public service.intranet.mef.model.Asset getAsset(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _assetLocalService.getAsset(id);
	}
	...
	*/
	@Override
	public service.intranet.mef.model.Asset updateAsset(
		service.intranet.mef.model.Asset asset) {
