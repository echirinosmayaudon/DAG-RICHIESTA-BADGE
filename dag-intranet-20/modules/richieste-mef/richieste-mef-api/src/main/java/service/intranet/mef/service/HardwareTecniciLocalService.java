...
/**
 * Provides the local service interface for HardwareTecnici. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see HardwareTecniciLocalServiceUtil
...
public interface HardwareTecniciLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link HardwareTecniciLocalServiceUtil} to access the hardware tecnici local service. Add custom service methods to {@link service.intranet.mef.service.impl.HardwareTecniciLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<HardwareTecnici> getHardwareTecnicis(int start, int end);
	...
	*/
	...
	public HardwareTecnici addHardwareTecnici(HardwareTecnici hardwareTecnici);
	...
	*/
	public HardwareTecnici createHardwareTecnici(long id);
	...
	*/
	...
	public HardwareTecnici deleteHardwareTecnici(long id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public HardwareTecnici deleteHardwareTecnici(
		HardwareTecnici hardwareTecnici);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public HardwareTecnici fetchHardwareTecnici(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public HardwareTecnici getHardwareTecnici(long id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public HardwareTecnici updateHardwareTecnici(
		HardwareTecnici hardwareTecnici);
}