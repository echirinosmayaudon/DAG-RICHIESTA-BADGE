...
public interface AssetLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AssetLocalServiceUtil} to access the asset local service. Add custom service methods to {@link service.intranet.mef.service.impl.AssetLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public Asset createAsset(long id);
	...
	*/
	...
	public Asset deleteAsset(long id) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Asset getAsset(long id) throws PortalException;
