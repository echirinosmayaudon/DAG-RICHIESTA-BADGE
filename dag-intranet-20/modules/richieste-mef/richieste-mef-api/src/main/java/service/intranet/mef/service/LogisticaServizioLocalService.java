...
/**
 * Provides the local service interface for LogisticaServizio. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LogisticaServizioLocalServiceUtil
...
public interface LogisticaServizioLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LogisticaServizioLocalServiceUtil} to access the logistica servizio local service. Add custom service methods to {@link service.intranet.mef.service.impl.LogisticaServizioLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LogisticaServizio> getLogisticaServizios(int start, int end);
	...
	*/
	...
	public LogisticaServizio addLogisticaServizio(
	...
	*/
	public LogisticaServizio createLogisticaServizio(long id);
	...
	*/
	...
	public LogisticaServizio deleteLogisticaServizio(long id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public LogisticaServizio deleteLogisticaServizio(
		LogisticaServizio logisticaServizio);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LogisticaServizio fetchLogisticaServizio(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LogisticaServizio getLogisticaServizio(long id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public LogisticaServizio updateLogisticaServizio(
		LogisticaServizio logisticaServizio);
}