...
/**
 * Provides the local service interface for LogisticaStato. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LogisticaStatoLocalServiceUtil
...
public interface LogisticaStatoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LogisticaStatoLocalServiceUtil} to access the logistica stato local service. Add custom service methods to {@link service.intranet.mef.service.impl.LogisticaStatoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LogisticaStato> getLogisticaStatos(int start, int end);
	...
	*/
	...
	public LogisticaStato addLogisticaStato(LogisticaStato logisticaStato);
	...
	*/
	public LogisticaStato createLogisticaStato(long id);
	...
	*/
	...
	public LogisticaStato deleteLogisticaStato(long id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public LogisticaStato deleteLogisticaStato(LogisticaStato logisticaStato);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LogisticaStato fetchLogisticaStato(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LogisticaStato getLogisticaStato(long id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public LogisticaStato updateLogisticaStato(LogisticaStato logisticaStato);
}