...
/**
 * Provides the local service interface for StatoRichBeneInv. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see StatoRichBeneInvLocalServiceUtil
...
public interface StatoRichBeneInvLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StatoRichBeneInvLocalServiceUtil} to access the stato rich bene inv local service. Add custom service methods to {@link service.intranet.mef.service.impl.StatoRichBeneInvLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<StatoRichBeneInv> getStatoRichBeneInvs(int start, int end);
	...
	*/
	...
	public StatoRichBeneInv addStatoRichBeneInv(
	...
	*/
	public StatoRichBeneInv createStatoRichBeneInv(long id);
	...
	*/
	...
	public StatoRichBeneInv deleteStatoRichBeneInv(long id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public StatoRichBeneInv deleteStatoRichBeneInv(
		StatoRichBeneInv statoRichBeneInv);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public StatoRichBeneInv fetchStatoRichBeneInv(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public StatoRichBeneInv getStatoRichBeneInv(long id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public StatoRichBeneInv updateStatoRichBeneInv(
		StatoRichBeneInv statoRichBeneInv);
}