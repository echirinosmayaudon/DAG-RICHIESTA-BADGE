...
/**
 * The persistence interface for the periodicita rich pubblic service.
 *
 * <p>
 ...
 * @see PeriodicitaRichPubblicUtil
 * @generated
 */
@ProviderType
public interface PeriodicitaRichPubblicPersistence extends BasePersistence<PeriodicitaRichPubblic> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PeriodicitaRichPubblicUtil} to access the periodicita rich pubblic persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(
		java.util.List<PeriodicitaRichPubblic> periodicitaRichPubblics);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, PeriodicitaRichPubblic> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<PeriodicitaRichPubblic> findAll();
	...
	*/
	public java.util.List<PeriodicitaRichPubblic> findAll(int start, int end);
	...
	*/
	public java.util.List<PeriodicitaRichPubblic> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<PeriodicitaRichPubblic> orderByComparator);
