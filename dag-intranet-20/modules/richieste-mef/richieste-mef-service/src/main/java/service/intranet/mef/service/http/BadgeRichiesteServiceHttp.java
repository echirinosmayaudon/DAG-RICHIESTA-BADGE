 ...
 * @see BadgeRichiesteServiceSoap
 * @see HttpPrincipal
 * @see BadgeRichiesteServiceUtil
 * @generated
 */
@ProviderType
public class BadgeRichiesteServiceHttp {
	public static com.liferay.portal.kernel.json.JSONArray findSuggestionsBySurname(
		...
		try {
			MethodKey methodKey = new MethodKey(BadgeRichiesteServiceUtil.class,
	...
	private static Log _log = LogFactoryUtil.getLog(BadgeRichiesteServiceHttp.class);
