...
import service.intranet.mef.exception.NoSuchAssetException;
import service.intranet.mef.model.Asset;
import service.intranet.mef.model.impl.AssetImpl;
import service.intranet.mef.model.impl.AssetModelImpl;
 ...
 * @see service.intranet.mef.service.persistence.AssetUtil
 * @generated
 */
@ProviderType
public class AssetPersistenceImpl extends BasePersistenceImpl<Asset>
	 ...
	 */
	@Override
	public Asset remove(long id) throws NoSuchAssetException {
	...
	protected Asset toUnwrappedModel(Asset asset) {
		...
		assetImpl.setDescrizione(asset.getDescrizione());
	 ...
	 */
	@Override
	public Asset findByPrimaryKey(long id) throws NoSuchAssetException {
	 ...
	 */
	@Override
	public Asset fetchByPrimaryKey(long id) {
	...
	private static final String _SQL_SELECT_ASSET_WHERE_PKS_IN = "SELECT asset FROM Asset asset WHERE id_ IN (";
