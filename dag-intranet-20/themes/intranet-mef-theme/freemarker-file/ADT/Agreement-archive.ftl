                ...
                <div class="ama-col-xs-12">
                    <div class="tab-filtri filtro-categoria">
                        <div class="filtro-tabs-wrapper top-paginator-scroll">
                           <span class="tab-title active"><@liferay.language key="all-agreement" /></span>
                        </div>
                                            ...
                                            <a href="" title="${categoryName}" class="filter-category-item-box mobile-benefits"  data-category-id="${categoryId}">
                                                <div class="benefits-item-icon">
                                                    ...
                                                    <#if categoryDescription == "">
                                                        ...
                                                        <#else>
                                                        <span class="icon-category icomoon-${categoryDescription}"></span></#if>
                                                    </div>
                                                </div>
                    ...
                    <div class="circolari-elenco-wrapper">
                        ...
                        <#if entries?has_content>
                            ...
                            <div class="ama-row">
                                <div class="ama-col-xs-12">
                                    <p class="copy-text wysiwyg-editor">non sono presenti convenzioni per i filtri selezionati</p>
                                </div>
                            </div>
                        </#if>
                        <div class="ama-row">
