                ...
                <div class="ama-col-xs-12">
                    <div class="tab-filtri filtro-categoria">
                        <div class="filtro-tabs-wrapper top-paginator-scroll">
                           <span class="tab-title text-uppercase active">Convenzioni Locali</span>
                        </div>
                    ...
                    <div class="circolari-elenco-wrapper">
                        ...
                        <#if entries?has_content>
                                        ...
                                        <div class="ama-row">
                                            <div class="ama-col-md-3 ama-col-sm-6 ama-col-xs-12">
                                                ...
                                                <#assign catCounterDescription = 0/>
                                                    ...
                                                    <a href="${viewURLNews}" target="_self" title="servizi" aria-label="servizi" class="style-title dot-point dot-70">${category.name}</a>
                                                    </#if>
                                            ...
                                            <div class="ama-col-md-9 ama-col-sm-6 ama-col-xs-12 border-left">
                                                <div class="clearfix">
                                                    <div class="wrapper-content-title">
                                                        <a href="${viewURLNews}" title="title" aria-label="title" class="second-title dot-point dot-50 is-truncated">${title}</a>
                            ...
                            <div class="ama-row">
                                <div class="ama-col-xs-12">
                                    <p class="copy-text wysiwyg-editor">non sono presenti convenzioni locali per i filtri selezionati</p>
                                </div>
                            </div>
                        </#if>
                        <div class="ama-row">
