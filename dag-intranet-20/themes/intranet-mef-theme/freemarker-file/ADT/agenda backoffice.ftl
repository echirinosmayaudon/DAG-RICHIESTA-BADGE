...
<#assign agendaArchivioPortalUrl = group.getExpandoBridge().getAttribute("url-archivio-agenda",false)>
<#if agendaArchivioPortalUrl != "">
    <#assign agendaArchiviolUrl = agendaArchivioPortalUrl>
</#if>
            ...
            <div class="ama-col-md-6">
                <div class="ama-row">
                    <div class="wrapper-title-agenda">
                            ...
                            <a href="${agendaArchiviolUrl}" title="Vai alla sezione" class="icomoon-vai">
                ...
                <#if (dateUtil.compareTo(dateEObj, dateSObj)> 0 )>
                    ...
                    <div class="container ${styleCol}">
                        ...
                        <div class="par">
                            ...
                            <div class="p-small dot-point dot-50 dot-mobile">
                              <#--${htmlUtil.unescape(description)}-->
                              ${description}
                            </div>
                        </div>
...
<#--
    ...
    <#macro renderWithTemplate article template>
        ...
        <#if validator.isNotNull(templateKey) && validator.isNotNull(article.getArticleId()) >
            <#attempt>
                <#assign articleDisplay = JournalArticleLocalService.getArticleDisplay(article.getGroupId(), article.getArticleId(), templateKey, "view", themeDisplay.getLanguageId(), themeDisplay) />
...
<div id="modalAgenda" class="modal modal-custom fade modal-icon-page" role="dialog">
	 ...
	 <div class="modal-content">
	  <div class="modal-body">
		<div class="modal-title-box">
			...
			<h2 id="modaltxtAgenda" class="text"> </h2>
...
<button class="button button-primary" id="refreshAgenda" data-toggle="modal" data-target="#modalAgenda" >Aggiorna</button>

<script>
$('#refreshAgenda').click("on",function(){
var htmlValue = $('#containerAgenda').html();
Liferay.Service(
  ...
  function(obj) {
    $('#modaltxtAgenda').text("");
    if(obj == "OK")
      $('#modaltxtAgenda').text("aggiornamento effettuato correttamente");

    else
      $('#modaltxtAgenda').text("errore durante l'aggiornamento");
  }
);
});
</script>
